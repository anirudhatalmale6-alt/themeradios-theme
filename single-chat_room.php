    ...
    <div class="chat-room-layout">
        <div class="chat-room-main">
            ...
            <div class="post-content" style="margin-top: 30px; padding: 24px; background: var(--bg-section); border-radius: 12px;">
                <h2 style="font-size: 22px; margin-bottom: 12px;">Descripcion Sala de Radio <?php the_title(); ?></h2>
                <?php the_content(); ?>
            </div>
            <?php endif; ?>
            ...
            <section class="related-rooms-section">
                <h2 class="section-title" style="font-size: 20px;">Estaciones de radio relacionadas:</h2>
