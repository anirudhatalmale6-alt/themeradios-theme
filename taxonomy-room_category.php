    ...
    <div class="container">
        ...
        <div class="category-header">
            ...
            <div class="category-header-info">
                <h1>Radios en la categoria <?php single_term_title(); ?></h1>
        ...
        <h1 class="section-title">Todas las Estaciones de Radio</h1>
        ...
        if ($featured->have_posts()) :
        ?>
        <h2 class="section-title" style="font-size: 20px; margin-top: 40px; margin-bottom: 20px;">Estaciones de Radio Recomendadas</h2>
        ...
        <div class="all-rooms-section" style="margin-top: 40px;">
            <h2 class="section-title" style="font-size: 20px; margin-bottom: 20px;">Todas las Estaciones</h2>
